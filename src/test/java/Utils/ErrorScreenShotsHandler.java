...
public class ErrorScreenShotsHandler {
    // Method to capture a screenshot
    public static String takeScreenshot(WebDriver driver, String screenshotName) {
        String timestamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(new Date());
        //String filePath = "src/test/resources/ScreenShots/" + screenshotName + "_" + timestamp + ".png";
        String filePath = "C:/Users/Nasrin/IdeaProjects/QA_Assignment/src/test/resources/ScreenShots" + screenshotName + "_" + timestamp + ".png";
        // Take the screenshot
