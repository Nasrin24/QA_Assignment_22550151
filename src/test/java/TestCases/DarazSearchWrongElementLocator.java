...
public class DarazSearchWrongElementLocator extends BaseTest {
    @BeforeTest
    public void setup() {
    ...
    public void searchAndBuyThinkpadLaptop() {
        ...
        // Read data
        String laptopBrand = excel.getCellData(1, 1); // Row 1, Column 0
        ...
        setReportName("Wrong Locator Scenario- Test Case 3");
        startTest("Wrong Locator Scenario- Test Case 3");
        // Write data back to the Excel file
        excel.setCellData(1, 2, "Thinkpad Selected", excelFilePath);
        ...
        try {
            ...
            String screenshotPath3 = ErrorScreenShotsHandler.takeScreenshot(driver, "wrong_locator_failure");
